...
@interface gmscViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation gmscViewController
...
-(void)json
{
    ...
    NSURLRequest *request=[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://114.215.170.1:8004/qsxk/api/GSService/getGmscList"]];
