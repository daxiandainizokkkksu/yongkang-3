...
@interface sq1ViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    NSMutableArray *arr1;
    NSMutableArray *arr2;
    NSMutableArray *arr3;
...
@implementation sq1ViewController
...
-(void)json
{
    ...
    if (response) {
        ...
        for (int i=0; i<array1.count; i++) {
            ...
            if ([[dicNew objectForKey:@"sttpname"]isEqual:@"水库站"]) {
                sum++;
